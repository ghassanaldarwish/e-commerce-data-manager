...
import { useEditController, useTranslate, TextInput, SimpleForm, DateField } from 'react-admin';
...
import StarRatingField from './StarRatingField.d';
    ...
    return (
        <div className={classes.root}>
            <div className={classes.title}>
                <Typography variant="h6">{translate('resources.reviews.detail')}</Typography>
