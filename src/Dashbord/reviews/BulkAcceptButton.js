...
import { Button, useUpdateMany, useNotify, useRedirect, useUnselectAll, CRUD_UPDATE_MANY } from 'react-admin';
...
const BulkAcceptButton = ({ selectedIds }) => {
    ...
    return (
        <Button label="resources.reviews.action.accept" onClick={approve} disabled={loading}>
            <ThumbUp />
        </Button>
    );
};
